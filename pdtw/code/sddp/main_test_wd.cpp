 ...
 *
 *
 * Test the waiting at depot cost
 *
*/
...
int main(int arg, char **argv) {
    ...
    configs.push_back(config(250, 6, 9999, 30));
    configs.push_back(config(250, 8, 9999, 30));
    configs.push_back(config(250, 10, 9999, 30));
    configs.push_back(config(250, 12, 9999, 30));
    configs.push_back(config(250, 14, 9999, 30));
...
void Execute(Scenarios &scenarios, config &conf) {
...

    {
        ...
        sim.Optimize(scenarios);
        conf.results.push_back(
                result(4, c, sim.distance, sim.unassigneds, sim.time_taken, sim.nb_routes, sim.nb_events));
    }

    {
        ...
        sim.Optimize(scenarios);
        conf.results.push_back(
                result(5, c, sim.distance, sim.unassigneds, sim.time_taken, sim.nb_routes, sim.nb_events));
    }
