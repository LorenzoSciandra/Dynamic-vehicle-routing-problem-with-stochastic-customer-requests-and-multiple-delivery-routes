...
class Parameters
{
	...
	public:
		...
		static void SetBranchAndRegret(bool b){_is_branch_and_regret = b;if(b) _is_sbpa = false;}
		static void SetSBPA(bool b){_is_sbpa = b; if(b) _is_branch_and_regret = false;}
