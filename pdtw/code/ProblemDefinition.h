...
public:
    ...
    Prob() : _nodes(0), _customers(0), _drivers(0), _requests(0), _nodes_request(0), _distances(NULL), _times(NULL),
             _dimension(0), _upper_bound(9999999999.9), _wanted_driver_count(0), _driver_lb(0), _driver_ub(0),
             nb_requests(0) {
    ...
    void SetMaxtrices(double **d, double **t, int dim) {
        _distances = d;
        _times = t;
        _dimension = dim;
    }
